...
import webGLLogo from '../../public/WebGL_Logo.svg';
import stripeLogo from '../../public/Stripe_Logo.svg';
import paypalLogo from '../../public/Paypal_Logo.svg';
...
import jQueryLogo from '../../public/jQuery_Logo.svg';
import nodeLogo from '../../public/NodeJS_Logo.svg'


// Responsitivity Input
import fmobile from '../../public/mobile-f.png';
import ftablet from '../../public/tablet-f.png';
import fdesktop from '../../public/desktop-f.png';


// ServiceGrid/InteractiveCard Input
import security from '../../public/security.png';
import web3 from '../../public/web3.png';
import seo from '../../public/seo.png';
import resp from '../../public/resp4.png';
...
// Responsitivity Output
export const buttonInfo = [
    {
        icon: fmobile,
        alt: 'mobile responsitivity',
        title: ' Mobile ',
        id: 'handleMobile',
    },
    {
        icon: ftablet,
        alt: 'tablet responsitivity',
        title: ' Tablet ',
        id: 'handleTablet',
    },
    {
        icon: fdesktop,
        alt: 'desktop responsitivity',
        title: 'Desktop',
        id: 'handleDesktop',
    },
]
...
// ServiceGrid/InteractiveCard Output
export const homepageServices = [
    {
        icon: security,
        subtitle: "Security",
        title: "Defend against malicious attacks →",
        body: "Deploy live app updates immediately to your users in realtime",
    },
    {
        icon: seo,
        subtitle: "SEO",
        title: "Grow your business's digital reach →",
        body: "Deploy live app updates immediately to your users in realtime",
    },
    {
        icon: resp,
        subtitle: "UI/UX Design",
        title: "User experiences designed for profit →",
        body: "Deploy live app updates immediately to your users in realtime",
    },
    {
        icon: web3,
        subtitle: "Web3",
        title: "Dive into the future, or get left behind →",
        body: "Deploy live app updates immediately to your users in realtime",
    },
]
