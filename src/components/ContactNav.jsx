...
import CadShield from '../../public/cadogy-shield-white.webp'
        ...
        <Popover className="z-[900] relative bg-[rgba(0,0,0,0.0)]">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
            ...
            <div className="-my-2 -mr-2 lg:hidden">
              <Popover.Button className="inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-violet-400 transition ease-in-out focus:outline-none focus:ring-2 focus:ring-inset focus:ring-black">
                  ...
                  <>
                    <Popover.Button
                      className={classNames(
                        open ? 'text-violet-400' : 'text-gray-500',
                        'group inline-flex items-center rounded-md text-base font-medium hover:text-violet-400 focus:outline-none'
                      )}
                    >
                      <span>Development</span>
                      <ChevronDownIcon
                        className={classNames(
                          open ? 'text--600' : 'text-gray-400',
                          'ml-2 h-5 w-5 group-hover:text-violet-400 transition ease-in-out'
                        )}
                        aria-hidden="true"
                      />
                    </Popover.Button>
                        ...
                        <div className="overflow-hidden shadow-lg rounded-2xl ring-1 ring-black ring-opacity-5">
                            ...
                            <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-6 lg:grid-cols-4">
                                ...
                                >
                                    ...
                                    <div className="ml-4">
                                    <p className="text-base text-violet-400">{item.name}</p>
            ...
            <div className="hidden items-center justify-end md:flex md:flex-[1_1_25%] lg:w-0">
              <a href="/blog" className="whitespace-nowrap text-base font-medium text-gray-200 hover:text-violet-400 transition ease-in-out">
                Blog
              </a>
              <a
                href="/contact-us"
                className="hover:scale-[1.05] transition-[0.3] hover:bg-[#ffffff66] bg-[#ffffff33] ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-2xl border hover:text-violet-100 border-transparent bg-origin-border px-4 py-2 text-base font-medium text-gray-200 shadow-sm hover:from-purple-700 hover:to-indigo-700">
                Contact Us
              </a>
            </div>
          </div>
              ...
              <div className="border divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-0 ring-black ring-opacity-5">
                    ...
                    <nav className="grid grid-cols-2 gap-7">
                      {solutions.map((item) => (
                        ...
                        >
                          ...
                          <div className="ml-4 text-base font-medium text-violet-400">{item.name}</div>
                        </a>
                      ))}
                    </nav>
                  </div>
                ...
                <div className="flex flex-row-reverse flex-wrap justify-between items-center px-6 py-6">
                  <div className="flex basis-[calc(50% - 40px)] justify-center flex-col gap-4">
                    <a href="/our-story" className="text-base font-medium text-violet-400 hover:text-gray-700">
                      Our Story
                    </a>
                    <a href="/our-impact" className="text-base font-medium text-violet-400 hover:text-gray-700">
                      Our Impact
                    </a>
                    <a href="/digital-experiences" className="text-base font-medium text-violet-400 hover:text-gray-700">
                      Digital Experiences
                    </a>
                    <a href="/case-studies" className="text-base font-medium text-violet-400 hover:text-gray-700">
                      Case Studies
                    </a>
                  </div>
                  <div className="mt-6">
                    ...
                    <p className="mt-6 text-center text-base font-medium text-gray-500">
                      <a href="/contact-us" className="text-violet-400">
                        Contact Us
                      </a>
                    </p>
                  </div>
