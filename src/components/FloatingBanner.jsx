...
export default function FloatingBanner() {
    return (
    <div className='bg-white relative  min-w-full min-h-full z-[999]'>
        <div className="z-[999] mx-auto rounded-br-2xl rounded-bl-2xl xl:w-[64.25%] sm:w-[94%]  bg-[rgba(22,22,22,1)]">
